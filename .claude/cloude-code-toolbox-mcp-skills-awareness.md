...
_Generated: 2026-09-04T16:51:16.145Z_
...
Workspace `mcp.json` _(folder: uws)_

- **c:\xampp\htdocs\uws\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Lenovo.DESKTOP-8K79SIL\.claude.json** — _File missing_
